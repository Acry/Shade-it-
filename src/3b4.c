 ...
 * DnD text
 * 
 * TODO put hang on text and shader init in function
 */
//END 	DESCRIPTION
...
//3 from header, one optionally loaded, one new/edit - makes 5
...
GLuint shading_program[5];	// Max GPU programs
...
// 		SDL_Log("%s",argv[1]);
	...
	Window = SDL_CreateWindow("3b4 - DnD text",
