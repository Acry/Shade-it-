 ...
 * 
 * Can be composed of different files or
 ...
 * 
 * RECENT: 
 * Use multiple Shader-Programs and swap during runtime
 * 
 * NEXT:
 * Bring STS back
 * using uniform_mouse
...
// 	(void)argv; // not needed yet
	...
	SDL_Window *Window = SDL_CreateWindow("0g - TESTING",
